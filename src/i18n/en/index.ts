...
const en = {
  ...
  DELETE_ERROR: "Could not delete the alias",
  DELETE_ERROR_DETAILED: "Error deleting alias {alias}: {error}",
  ...
  UPDATE_ERROR: "Alias could not be saved",
  UPDATE_ERROR_DETAILED: "Error saving alias {alias}: {error}",
