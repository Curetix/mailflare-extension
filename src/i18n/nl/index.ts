...
const nl = {
  ...
  EMAIL_ROUTING_NOT_ENABLED_TITLE: "Oeps!",
  EMAIL_ROUTING_NOT_ENABLED: "Email Routing is uitgeschakeld of niet goed geconfigureerd voor dit domein. Controleer de configuratie hier: ",
